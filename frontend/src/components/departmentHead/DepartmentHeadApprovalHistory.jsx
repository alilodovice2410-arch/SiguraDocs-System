...
import "./css/DepartmentHeadApprovalHistory.css";

function DepartmentHeadApprovalHistory() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      const response = await api.get("/department-head/approval-history", {
        params,
      });
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case "revision_requested":
        return <RefreshCw className="status-icon-revision" />;
      default:
  ...
  if (loading) {
    return (
      <div className="dept-history-container">
        ...
        <div className="filter-buttons-group">
          ...
          <button
            className={`filter-button ${
              filter === "revision_requested" ? "active" : ""
            }`}
      ...
      <div className="review-timeline-section">
        ...
        {filteredHistory.length === 0 ? (
          <div className="history-empty-state">
            ...
            <p>
              {filter === "all"
                ? "Documents you review will appear here"
...
export default DepartmentHeadApprovalHistory;
